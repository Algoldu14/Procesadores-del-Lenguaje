...
public class gPL2Parser extends Parser {
	...
	public static final int COMENTARIOABRIR = 1, COMENTARIOLINEA = 2, PALGORITMO = 3, PFINALGORITMO = 4, PFUNCION = 5,
			PFINFUNCION = 6, PDEFINIR = 7, PCOMO = 8, PLEER = 9, PESCRIBIR = 10, PSI = 11, PENTONCES = 12, PSINO = 13,
			PFINSI = 14, PPARA = 15, PHASTA = 16, PHACER = 17, PFINPARA = 18, PMIENTRAS = 19, PFINMIENTRAS = 20,
			PREPETIR = 21, PHASTAQUE = 22, PSEGUN = 23, PDEOTROMODO = 24, PFINSEGUN = 25, PTIPOS = 26, PDIMENSION = 27,
			ASIGNACION = 28, MAS = 29, MENOS = 30, IGUAL = 31, MAYOR = 32, MENOR = 33, COMA = 34, DOSPUNTOS = 35,
			PI = 36, PD = 37, CI = 38, CD = 39, Y = 40, DIGITO = 41, ID = 42, PUNTOCOMA = 43, TERMINAL = 44, ESC = 45,
			CADENA = 46, WS = 47, COMENTARIOCERRAR = 48, TEXTOCOMENTARIOML = 49, FINAL_COMENTARIO_UL = 50,
			TEXTOCOMENTARIOUL = 51;
	public static final int RULE_identificador = 0, RULE_pfinfuncion = 1, RULE_prog = 2, RULE_definicion = 3,
			RULE_algoritmo = 4, RULE_si = 5, RULE_para = 6, RULE_mientras = 7, RULE_repetir = 8, RULE_segun = 9,
			RULE_funcion = 10, RULE_argumentos = 11, RULE_dimension = 12, RULE_bloque = 13, RULE_expresion = 14,
			RULE_llamadaFuncion = 15, RULE_operacion = 16, RULE_array = 17, RULE_textos = 18, RULE_linea = 19,
			RULE_cabezafuncion = 20, RULE_cuerpofuncion = 21, RULE_comentario = 22;

	private static String[] makeRuleNames() {
		return new String[] { "identificador", "pfinfuncion", "prog", "definicion", "algoritmo", "si", "para",
				"mientras", "repetir", "segun", "funcion", "argumentos", "dimension", "bloque", "expresion",
				"llamadaFuncion", "operacion", "array", "textos", "linea", "cabezafuncion", "cuerpofuncion",
				"comentario" };
	}
	...
	private static String[] makeLiteralNames() {
		return new String[] { null, "'/**'", "'//'", "'Algoritmo'", "'FinAlgoritmo'", "'Funcion'", null, null, "'Como'",
				"'Leer'", "'Escribir'", "'Si'", "'Entonces'", "'SiNo'", null, "'Para'", "'Hasta'", "'Hacer'",
				"'FinPara'", "'Mientras'", null, "'Repetir'", "'Hasta Que'", "'Segun'", "'De Otro Modo'", "'FinSegun'",
				null, null, "'<-'", "'+'", "'-'", "'='", "'<'", "'>'", "','", "':'", "'('", "')'", "'['", "']'", "'&'",
	...
	private static String[] makeSymbolicNames() {
		return new String[] { null, "COMENTARIOABRIR", "COMENTARIOLINEA", "PALGORITMO", "PFINALGORITMO", "PFUNCION",
				"PFINFUNCION", "PDEFINIR", "PCOMO", "PLEER", "PESCRIBIR", "PSI", "PENTONCES", "PSINO", "PFINSI",
				"PPARA", "PHASTA", "PHACER", "PFINPARA", "PMIENTRAS", "PFINMIENTRAS", "PREPETIR", "PHASTAQUE", "PSEGUN",
				"PDEOTROMODO", "PFINSEGUN", "PTIPOS", "PDIMENSION", "ASIGNACION", "MAS", "MENOS", "IGUAL", "MAYOR",
				"MENOR", "COMA", "DOSPUNTOS", "PI", "PD", "CI", "CD", "Y", "DIGITO", "ID", "PUNTOCOMA", "TERMINAL",
				"ESC", "CADENA", "WS", "COMENTARIOCERRAR", "TEXTOCOMENTARIOML", "FINAL_COMENTARIO_UL",
				"TEXTOCOMENTARIOUL" };
	}
	...
	public static class IdentificadorContext extends ParserRuleContext {
		public TerminalNode ID() {
			return getToken(gPL2Parser.ID, 0);
		}
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof gPL2ParserListener)
				((gPL2ParserListener) listener).enterIdentificador(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof gPL2ParserListener)
				((gPL2ParserListener) listener).exitIdentificador(this);
		}
	}
	...
	public static class PfinfuncionContext extends ParserRuleContext {
		public TerminalNode PFINFUNCION() {
			return getToken(gPL2Parser.PFINFUNCION, 0);
		}
		...
		@Override
		public int getRuleIndex() {
			return RULE_pfinfuncion;
		}

		@Override
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof gPL2ParserListener)
				((gPL2ParserListener) listener).enterPfinfuncion(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof gPL2ParserListener)
				((gPL2ParserListener) listener).exitPfinfuncion(this);
		}
	}
	...
	public static class ProgContext extends ParserRuleContext {
		public List<TerminalNode> TERMINAL() {
			return getTokens(gPL2Parser.TERMINAL);
		}
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof gPL2ParserListener)
				((gPL2ParserListener) listener).enterProg(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof gPL2ParserListener)
				((gPL2ParserListener) listener).exitProg(this);
		}
	}
	...
	public final ProgContext prog() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				_la = _input.LA(1);
				while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << COMENTARIOABRIR) | (1L << COMENTARIOLINEA)
						| (1L << PALGORITMO) | (1L << PFUNCION))) != 0)) {
					{
						{
							setState(53);
							_errHandler.sync(this);
	...
	public static class DefinicionContext extends ParserRuleContext {
		public TerminalNode PDEFINIR() {
			return getToken(gPL2Parser.PDEFINIR, 0);
		}
		...
		public TerminalNode PCOMO() {
			return getToken(gPL2Parser.PCOMO, 0);
		}

		public TerminalNode PTIPOS() {
			return getToken(gPL2Parser.PTIPOS, 0);
		}

		public List<TerminalNode> COMA() {
			return getTokens(gPL2Parser.COMA);
		}
		...
		public TerminalNode PUNTOCOMA() {
			return getToken(gPL2Parser.PUNTOCOMA, 0);
		}
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof gPL2ParserListener)
				((gPL2ParserListener) listener).enterDefinicion(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof gPL2ParserListener)
				((gPL2ParserListener) listener).exitDefinicion(this);
		}
	}
	...
	public static class AlgoritmoContext extends ParserRuleContext {
		public TerminalNode PALGORITMO() {
			return getToken(gPL2Parser.PALGORITMO, 0);
		}
		...
		public TerminalNode PFINALGORITMO() {
			return getToken(gPL2Parser.PFINALGORITMO, 0);
		}

		public TerminalNode TERMINAL() {
			return getToken(gPL2Parser.TERMINAL, 0);
		}
		...
		@Override
		public int getRuleIndex() {
			return RULE_algoritmo;
		}

		@Override
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof gPL2ParserListener)
				((gPL2ParserListener) listener).enterAlgoritmo(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof gPL2ParserListener)
				((gPL2ParserListener) listener).exitAlgoritmo(this);
		}
	}
	...
	public final AlgoritmoContext algoritmo() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				_la = _input.LA(1);
				while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << COMENTARIOABRIR) | (1L << COMENTARIOLINEA)
						| (1L << PDEFINIR) | (1L << PLEER) | (1L << PESCRIBIR) | (1L << PSI) | (1L << PPARA)
						| (1L << PMIENTRAS) | (1L << PREPETIR) | (1L << PSEGUN) | (1L << PDIMENSION) | (1L << PI)
						| (1L << DIGITO) | (1L << ID) | (1L << CADENA))) != 0)) {
					{
						setState(83);
						_errHandler.sync(this);
						switch (_input.LA(1)) {
	...
	public static class SiContext extends ParserRuleContext {
		public TerminalNode PSI() {
			return getToken(gPL2Parser.PSI, 0);
		}
		...
		public TerminalNode PENTONCES() {
			return getToken(gPL2Parser.PENTONCES, 0);
		}

		public TerminalNode PFINSI() {
			return getToken(gPL2Parser.PFINSI, 0);
		}
		...
		public TerminalNode PSINO() {
			return getToken(gPL2Parser.PSINO, 0);
		}
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof gPL2ParserListener)
				((gPL2ParserListener) listener).enterSi(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof gPL2ParserListener)
				((gPL2ParserListener) listener).exitSi(this);
		}
	}
				...
				switch (_input.LA(1)) {
					...
					case CADENA: {
						...
						while ((((_la) & ~0x3f) == 0 && ((1L << _la)
								& ((1L << COMENTARIOABRIR) | (1L << COMENTARIOLINEA) | (1L << PLEER) | (1L << PESCRIBIR)
										| (1L << PI) | (1L << DIGITO) | (1L << ID) | (1L << CADENA))) != 0)) {
							{
								{
									setState(93);
									linea();
				...
				if (_la == PSINO) {
					{
						...
						switch (_input.LA(1)) {
							...
							case CADENA: {
								...
								_errHandler.sync(this);
								_la = _input.LA(1);
								while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << COMENTARIOABRIR)
										| (1L << COMENTARIOLINEA) | (1L << PLEER) | (1L << PESCRIBIR) | (1L << PI)
										| (1L << DIGITO) | (1L << ID) | (1L << CADENA))) != 0)) {
									{
										{
											setState(103);
	...
	public static class ParaContext extends ParserRuleContext {
		public TerminalNode PPARA() {
			return getToken(gPL2Parser.PPARA, 0);
		}
		...
		public TerminalNode PHASTA() {
			return getToken(gPL2Parser.PHASTA, 0);
		}

		public TerminalNode PHACER() {
			return getToken(gPL2Parser.PHACER, 0);
		}

		public TerminalNode PFINPARA() {
			return getToken(gPL2Parser.PFINPARA, 0);
		}
		...
		public TerminalNode DIGITO() {
			return getToken(gPL2Parser.DIGITO, 0);
		}
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof gPL2ParserListener)
				((gPL2ParserListener) listener).enterPara(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof gPL2ParserListener)
				((gPL2ParserListener) listener).exitPara(this);
		}
	}
	...
	public static class MientrasContext extends ParserRuleContext {
		public TerminalNode PMIENTRAS() {
			return getToken(gPL2Parser.PMIENTRAS, 0);
		}
		...
		public TerminalNode PFINMIENTRAS() {
			return getToken(gPL2Parser.PFINMIENTRAS, 0);
		}
		...
		@Override
		public int getRuleIndex() {
			return RULE_mientras;
		}

		@Override
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof gPL2ParserListener)
				((gPL2ParserListener) listener).enterMientras(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof gPL2ParserListener)
				((gPL2ParserListener) listener).exitMientras(this);
		}
	}
	...
	public final MientrasContext mientras() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				while ((((_la) & ~0x3f) == 0 && ((1L << _la)
						& ((1L << COMENTARIOABRIR) | (1L << COMENTARIOLINEA) | (1L << PLEER) | (1L << PESCRIBIR)
								| (1L << PSI) | (1L << PI) | (1L << DIGITO) | (1L << ID) | (1L << CADENA))) != 0)) {
					{
						setState(139);
						_errHandler.sync(this);
						switch (_input.LA(1)) {
	...
	public static class RepetirContext extends ParserRuleContext {
		public TerminalNode PREPETIR() {
			return getToken(gPL2Parser.PREPETIR, 0);
		}

		public TerminalNode PHASTAQUE() {
			return getToken(gPL2Parser.PHASTAQUE, 0);
		}
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof gPL2ParserListener)
				((gPL2ParserListener) listener).enterRepetir(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof gPL2ParserListener)
				((gPL2ParserListener) listener).exitRepetir(this);
		}
	}
	...
	public static class SegunContext extends ParserRuleContext {
		public TerminalNode PSEGUN() {
			return getToken(gPL2Parser.PSEGUN, 0);
		}
		...
		public TerminalNode PFINSEGUN() {
			return getToken(gPL2Parser.PFINSEGUN, 0);
		}
		...
		public List<TerminalNode> DOSPUNTOS() {
			return getTokens(gPL2Parser.DOSPUNTOS);
		}
		...
		public TerminalNode PDEOTROMODO() {
			return getToken(gPL2Parser.PDEOTROMODO, 0);
		}

		public List<TerminalNode> CADENA() {
			return getTokens(gPL2Parser.CADENA);
		}
		...
		public List<TerminalNode> DIGITO() {
			return getTokens(gPL2Parser.DIGITO);
		}
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof gPL2ParserListener)
				((gPL2ParserListener) listener).enterSegun(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof gPL2ParserListener)
				((gPL2ParserListener) listener).exitSegun(this);
		}
	}
	...
	public static class FuncionContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof gPL2ParserListener)
				((gPL2ParserListener) listener).enterFuncion(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof gPL2ParserListener)
				((gPL2ParserListener) listener).exitFuncion(this);
		}
	}
	...
	public static class ArgumentosContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof gPL2ParserListener)
				((gPL2ParserListener) listener).enterArgumentos(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof gPL2ParserListener)
				((gPL2ParserListener) listener).exitArgumentos(this);
		}
	}
		...
		try {
			...
			switch (getInterpreter().adaptivePredict(_input, 24, _ctx)) {
				...
				case 2:
					...
					_la = _input.LA(1);
					while ((((_la) & ~0x3f) == 0 && ((1L << _la)
							& ((1L << COMA) | (1L << PI) | (1L << DIGITO) | (1L << ID) | (1L << CADENA))) != 0)) {
						{
							setState(198);
							_errHandler.sync(this);
							switch (_input.LA(1)) {
	...
	public static class DimensionContext extends ParserRuleContext {
		public TerminalNode PDIMENSION() {
			return getToken(gPL2Parser.PDIMENSION, 0);
		}
		...
		public TerminalNode CI() {
			return getToken(gPL2Parser.CI, 0);
		}

		public TerminalNode CD() {
			return getToken(gPL2Parser.CD, 0);
		}
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof gPL2ParserListener)
				((gPL2ParserListener) listener).enterDimension(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof gPL2ParserListener)
				((gPL2ParserListener) listener).exitDimension(this);
		}
	}
	...
	public static class BloqueContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof gPL2ParserListener)
				((gPL2ParserListener) listener).enterBloque(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof gPL2ParserListener)
				((gPL2ParserListener) listener).exitBloque(this);
		}
	}
	...
	public static class ExpresionContext extends ParserRuleContext {
		public TerminalNode PESCRIBIR() {
			return getToken(gPL2Parser.PESCRIBIR, 0);
		}
		...
		public TerminalNode PLEER() {
			return getToken(gPL2Parser.PLEER, 0);
		}
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof gPL2ParserListener)
				((gPL2ParserListener) listener).enterExpresion(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof gPL2ParserListener)
				((gPL2ParserListener) listener).exitExpresion(this);
		}
	}
	...
	public static class LlamadaFuncionContext extends ParserRuleContext {
		...
		public TerminalNode PI() {
			return getToken(gPL2Parser.PI, 0);
		}

		public TerminalNode PD() {
			return getToken(gPL2Parser.PD, 0);
		}
		...
		@Override
		public int getRuleIndex() {
			return RULE_llamadaFuncion;
		}

		@Override
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof gPL2ParserListener)
				((gPL2ParserListener) listener).enterLlamadaFuncion(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof gPL2ParserListener)
				((gPL2ParserListener) listener).exitLlamadaFuncion(this);
		}
	}
	...
	public final LlamadaFuncionContext llamadaFuncion() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0
						&& ((1L << _la) & ((1L << PI) | (1L << DIGITO) | (1L << ID) | (1L << CADENA))) != 0)) {
					{
						setState(247);
						argumentos();
					}
	...
	public static class OperacionContext extends ParserRuleContext {
		...
		public TerminalNode ASIGNACION() {
			return getToken(gPL2Parser.ASIGNACION, 0);
		}
		...
		public List<TerminalNode> MAS() {
			return getTokens(gPL2Parser.MAS);
		}
		...
		public List<TerminalNode> MENOS() {
			return getTokens(gPL2Parser.MENOS);
		}
		...
		public TerminalNode IGUAL() {
			return getToken(gPL2Parser.IGUAL, 0);
		}

		public TerminalNode MAYOR() {
			return getToken(gPL2Parser.MAYOR, 0);
		}

		public TerminalNode MENOR() {
			return getToken(gPL2Parser.MENOR, 0);
		}
		...
		public TerminalNode Y() {
			return getToken(gPL2Parser.Y, 0);
		}
		...
		@Override
		public int getRuleIndex() {
			return RULE_operacion;
		}

		@Override
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof gPL2ParserListener)
				((gPL2ParserListener) listener).enterOperacion(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof gPL2ParserListener)
				((gPL2ParserListener) listener).exitOperacion(this);
		}
	}
			...
			enterOuterAlt(_localctx, 1);
			{
				...
				switch (getInterpreter().adaptivePredict(_input, 40, _ctx)) {
					...
					case 6: {
						...
						_la = _input.LA(1);
						if (!((((_la) & ~0x3f) == 0
								&& ((1L << _la) & ((1L << IGUAL) | (1L << MAYOR) | (1L << MENOR))) != 0))) {
							_errHandler.recoverInline(this);
						} else {
							if (_input.LA(1) == Token.EOF)
								matchedEOF = true;
	...
	public static class ArrayContext extends ParserRuleContext {
		...
		public TerminalNode COMA() {
			return getToken(gPL2Parser.COMA, 0);
		}
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof gPL2ParserListener)
				((gPL2ParserListener) listener).enterArray(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof gPL2ParserListener)
				((gPL2ParserListener) listener).exitArray(this);
		}
	}
	...
	public static class TextosContext extends ParserRuleContext {
		public List<TerminalNode> TEXTOCOMENTARIOML() {
			return getTokens(gPL2Parser.TEXTOCOMENTARIOML);
		}
		...
		public List<TerminalNode> TEXTOCOMENTARIOUL() {
			return getTokens(gPL2Parser.TEXTOCOMENTARIOUL);
		}
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof gPL2ParserListener)
				((gPL2ParserListener) listener).enterTextos(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof gPL2ParserListener)
				((gPL2ParserListener) listener).exitTextos(this);
		}
	}
	...
	public static class LineaContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof gPL2ParserListener)
				((gPL2ParserListener) listener).enterLinea(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof gPL2ParserListener)
				((gPL2ParserListener) listener).exitLinea(this);
		}
	}
	...
	public static class CabezafuncionContext extends ParserRuleContext {
		public TerminalNode PFUNCION() {
			return getToken(gPL2Parser.PFUNCION, 0);
		}
		...
		@Override
		public int getRuleIndex() {
			return RULE_cabezafuncion;
		}

		@Override
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof gPL2ParserListener)
				((gPL2ParserListener) listener).enterCabezafuncion(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof gPL2ParserListener)
				((gPL2ParserListener) listener).exitCabezafuncion(this);
		}
	}
	...
	public static class CuerpofuncionContext extends ParserRuleContext {
		...
		@Override
		public int getRuleIndex() {
			return RULE_cuerpofuncion;
		}

		@Override
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof gPL2ParserListener)
				((gPL2ParserListener) listener).enterCuerpofuncion(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof gPL2ParserListener)
				((gPL2ParserListener) listener).exitCuerpofuncion(this);
		}
	}
	...
	public final CuerpofuncionContext cuerpofuncion() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				_la = _input.LA(1);
				while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << COMENTARIOABRIR) | (1L << COMENTARIOLINEA)
						| (1L << PLEER) | (1L << PESCRIBIR) | (1L << PI) | (1L << DIGITO) | (1L << ID)
						| (1L << TERMINAL) | (1L << CADENA))) != 0)) {
					{
						setState(365);
						_errHandler.sync(this);
						switch (_input.LA(1)) {
	...
	public static class ComentarioContext extends ParserRuleContext {
		public TerminalNode COMENTARIOABRIR() {
			return getToken(gPL2Parser.COMENTARIOABRIR, 0);
		}

		public TerminalNode COMENTARIOCERRAR() {
			return getToken(gPL2Parser.COMENTARIOCERRAR, 0);
		}
		...
		public TerminalNode COMENTARIOLINEA() {
			return getToken(gPL2Parser.COMENTARIOLINEA, 0);
		}

		public TerminalNode FINAL_COMENTARIO_UL() {
			return getToken(gPL2Parser.FINAL_COMENTARIO_UL, 0);
		}
		...
		@Override
		public int getRuleIndex() {
			return RULE_comentario;
		}

		@Override
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof gPL2ParserListener)
				((gPL2ParserListener) listener).enterComentario(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof gPL2ParserListener)
				((gPL2ParserListener) listener).exitComentario(this);
		}
	}
		...
		try {
			...
			switch (_input.LA(1)) {
				case COMENTARIOABRIR:
					...
					_la = _input.LA(1);
					while ((((_la) & ~0x3f) == 0 && ((1L << _la)
							& ((1L << TERMINAL) | (1L << TEXTOCOMENTARIOML) | (1L << TEXTOCOMENTARIOUL))) != 0)) {
						{
							setState(373);
							_errHandler.sync(this);
							switch (_input.LA(1)) {
	...
	public static final String _serializedATN = "\3\u608b\ua72a\u8133\ub9ed\u417c\u3be7\u7786\u5964\3\65\u0188\4\2\t\2"
